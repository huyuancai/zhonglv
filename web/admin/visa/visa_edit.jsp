...
<script type="text/javascript">
	$().ready(function(){
		$("#Button1").click(function(){
			...
			var visa_id = $("input[name='visa_id']").val();
			if ( !visa_name  ) {
				alert("签证名称不能为空！");
				return false;
			}
...
<body>
	<table style="width:100%;" border="0" cellpadding="0" cellspacing="1" class="black_border">
		<tbody>
			<tr class="suphead">
		        <td colspan="2">签证编辑</td>
		    </tr>
		    <tr>
		    	<td class="fields_text">名称：</td>
		      	<td class="fields_input">
		          	<input name="visa_name" type="text" value="<s:property value="#request.visaVO.getVisaName()"/>" id="visa_name" class="input_long">
		          	<input name="visa_id" type="hidden" value="<s:property value="#request.visaVO.getVisaId()"/>" id="visa_id">
    		...
    		<tr>
		      	...
		      	<td class="fields_input">
		          	<span id="rbType">
		          		<s:iterator var="visaTypeVO" value="#request.visaTypeVOs" status="s">
			          		<input id="visa_type_<s:property value="#s.index"/>" type="radio" <s:if test="#request.visaVO.getVisaType()==#visaTypeVO.getTypeId()">checked="checked"</s:if> name="visa_type" value="<s:property value="#visaTypeVO.getTypeId()"/>">
		      ...
		      <td class="fields_input">
		        ...
		        <input name="visa_thumb" id="visa_thumb" value="<s:property value="#request.visaVO.getVisaThumb()"/>" type="hidden" />
		    ...
		    <tr>
		      	...
		      	<td class="fields_input">
		        	<input name="visa_price" type="text" value="<s:property value="#request.visaVO.getVisaPrice()"/>" id="visa_type" class="input_mini" style="width:51px;">
		    ...
		    <tr>
		      	...
		      	<td class="fields_input">
		        	<input name="visa_validity" type="text" value="<s:property value="#request.visaVO.getVisaValidity()"/>" id="visa_validity" class="input_middle">
		        </td>
		    </tr>
    		<tr>
		      	<td class="fields_text" valign="top">办理时长：</td>
		      	<td class="fields_input">
		        	<input name="visa_process_time" type="text" value="<s:property value="#request.visaVO.getVisaProcessTime()"/>" id="visa_process_time" class="input_middle">
		        </td>
		    </tr>
		    <tr>
		      	<td class="fields_text" valign="top">最长停留时间：</td>
		      	<td class="fields_input">
		        	<input name="visa_max_stay" type="text" value="<s:property value="#request.visaVO.getVisaMaxStay()"/>" id="visa_max_stay" class="input_middle">
		        </td>
		    </tr>
		    <tr>
		      	<td class="fields_text" valign="top">入境次数：</td>
		      	<td class="fields_input">
		        	<input name="visa_immigrants_times" type="text" value="<s:property value="#request.visaVO.getVisaImmigrantsTimes()"/>" id="visa_immigrants_times" class="input_middle">
		        </td>
		    </tr>
		    <tr>
		      	<td class="fields_text" valign="top">面试：</td>
		      	<td class="fields_input">
		        	<input name="visa_interview" type="text" value="<s:property value="#request.visaVO.getVisaInterview()"/>" id="visa_interview" class="input_middle">
		        </td>
		    </tr>
		    <tr>
		    	<td class="fields_text">摘要：</td>
		      	<td class="fields_input">
		        	<textarea name="visa_summary" rows="2" cols="20" id="visa_summary" class="text_content"><s:property value="#request.visaVO.getVisaSummary()"/></textarea>
		      	</td>
		    </tr>
    		<tr>
		        	...
		        	<div style="display: block; height: 238px;" class="ke-edit">
		        		...
		        		<script>
							...
							KindEditor.ready(function(K) {
								...
								editor1.html(HTMLDecode('<s:property value="#request.visaVO.getVisaMaterials()"/>'));
							});
						</script>
		        	</div>
			    </div>
		        	...
		        	<div style="display: block; height: 238px;" class="ke-edit">
		        		...
		        		<script>
							...
							KindEditor.ready(function(K) {
								...
								editor2.html(HTMLDecode('<s:property value="#request.visaVO.getVisaIntroduction()"/>'));
							});
						</script>
		        	</div>
			    </div>
		    ...
		    <tr>
		      	<td class="fields_text">
		       	...
		       	<td align="left" height="30" class="fields_input">
					点击：<input name="visa_count" type="text" id="visa_count" value="<s:property value="#request.visaVO.getVisaCount()"/>" class="input_mini" style="width:51px;">
		      	</td>
		    </tr>
		    <tr>
		      <td></td>
