...
<script type="text/javascript">
	...
	function iniTopics(){
		var topicsList = '<s:property value="#request.routeVO.getTopics()"/>';
		var topics = topicsList.split(",");
		var $topicsList = $("input[name='topics']");
		$topicsList.each(function(idx,obj){
			for ( x in topics) {
				if ( $(obj).val() == topics[x].trim() ) {
...
<body>
	<table style="width:100%;" border="0" cellpadding="0" cellspacing="1" class="black_border">
     		<tbody>
     			<tr class="suphead">
		        <td colspan="2">编辑线路</td>
		    </tr>
   			<tr>
     				<td class="fields_text">线路名称：</td>
			    <td class="fields_input">
		    	  <input name="route_id" type="hidden" value="<s:property value="#request.routeVO.getRouteId()"/>"/>
		          <input name="route_name" type="text" id="route_name" class="input_long" value="<s:property value="#request.routeVO.getRouteName()"/>">
		          <span id="RequiredFieldValidator1" style="color:Red;">(*)</span>
			                编号：<input name="route_number" type="text" id="route_number" value="<s:property value="#request.routeVO.getRouteNumber()"/>" class="input_normal">
			    </td>
   			</tr>
		   	<tr>
		     	<td class="fields_text">标&nbsp; 题：</td>
		     	<td class="fields_input">
		     		<input name="route_title" type="text" id="route_title" value="<s:property value="#request.routeVO.getRouteTitle()"/>" class="input_long">
		     	</td>
		   	</tr>
		   	<tr>
		    ...
		    <tr>
		        ...
		        <select name="route_type" id="route_type">
					<s:iterator var="routeTypeVO" value="#request.routeTypeVOs">
						<option value="<s:property value="#routeTypeVO.getRouteTypeId()"/>" <s:if test="#request.routeVO.getRouteType() == #routeTypeVO.getRouteTypeId()">selected="selected"</s:if>><s:property value="#routeTypeVO.getRouteTypeName()"/></option>
		        	</s:iterator>
				</select>
				&nbsp;天数：<input name="route_days" type="text" id="route_days" value="<s:property value="#request.routeVO.getRouteDays()"/>" class="input_mini">天
			  	</td>
		  	</tr>
		    <tr>
		      ...
		      <td class="fields_input">
		        ...
		        <input name="route_thumb" id="route_thumb" value="<s:property value="#request.routeVO.getRouteThumb()"/>" type="hidden" />
		      ...
		      <td class="fields_input">          
		          <select name="route_destination_city" id="route_destination_city">
		            <s:iterator var="destinationCityVO" value="#request.destinationCityVOs">
						<option value="<s:property value="#destinationCityVO.getDesCityId()"/>" <s:if test="#request.routeVO.getRouteDestinationCity() == #destinationCityVO.getDesCityId()">selected="selected"</s:if>><s:property value="#destinationCityVO.getDesCityName()"/></option>
		        	</s:iterator>
		          </select>
		          &nbsp;交通方式：<input name="route_transport_mode" type="text" id="route_transport_mode" value="<s:property value="#request.routeVO.getRouteTransportMode()"/>" class="input_normal">
		          &nbsp;出发日期：<input name="route_departure_date" type="text" id="route_departure_date" value="<s:date name="#request.routeVO.getRouteDepartureDate()" format="yyyy-MM-dd"/>" class="input_middle Wdate" readonly="readonly" onclick="WdatePicker()">
		          </td>
		    </tr>
		    <tr>
		      <td class="fields_text">价格：</td>
		      <td class="fields_input">
			  	<input name="route_price" type="text" value="<s:property value="#request.routeVO.getRoutePrice()"/>"" id="route_price" class="input_mini" style="width:51px;"> 元
		      </td>
		    </tr>
		    <tr>
		      ...
		      <td class="fields_input">
		        <select name="route_departure_city" id="route_departure_city">
					<s:iterator var="departureCityVO" value="#request.departureCityVOs">
						<option value="<s:property value="#departureCityVO.getDepCityId()"/>" <s:if test="#request.routeVO.getRouteDepartureCity() == #departureCityVO.getDepCityId()">selected="selected"</s:if>><s:property value="#departureCityVO.getDepCityName()"/></option>
		        	</s:iterator>
				</select>
		        &nbsp;至少提前<input name="route_destine_days" type="text" id="route_destine_days" value="<s:property value="#request.routeVO.getRouteDestineDays()"/>" class="input_mini">天预定</td>
		    </tr>
		    <tr>
		      <td class="fields_text">
		                    摘要：</td>
		      <td class="fields_input">
		        <textarea name="route_summary" rows="2" cols="20" id="route_summary" class="text_content"><s:property value="#request.routeVO.getRouteSummary()"/></textarea>
		      </td>
		    </tr>
		    <tr>
		        	...
		        	<div style="display: block; height: 238px;" class="ke-edit">
		        		...
		        		<script>
							...
							KindEditor.ready(function(K) {
								...
								editor1.html(HTMLDecode("<s:property value='#request.routeVO.getRouteFeatureDesc()'/>"));
							});
						</script>
		        	</div>
			    </div>
		        	...
		        	<div style="display: block; height: 238px;" class="ke-edit">
		        		...
		        		<script>
							...
							KindEditor.ready(function(K) {
								...
								editor2.html(HTMLDecode("<s:property value='#request.routeVO.getRouteBookingPolicy()'/>"));
							});
						</script>
		        	</div>  
		        </div>       
		        	...
		        	<div style="display: block; height: 238px;" class="ke-edit">
		        		...
		        		<script>
							...
							KindEditor.ready(function(K) {
								...
								editor3.html(HTMLDecode("<s:property value='#request.routeVO.getRouteTips()'/>"));
							});
						</script>
		        	</div> 
		        </div>       
		        	...
		        	<div style="display: block; height: 238px;" class="ke-edit">
		        		...
		        		<script>
							...
							KindEditor.ready(function(K) {
								...
								editor4.html(HTMLDecode("<s:property value='#request.routeVO.getRouteItinerary()'/>"));
							});
						</script>
		        	</div>
		        </div>         
		        	...
		        	<div style="display: block; height: 238px;" class="ke-edit">
		        		...
		        		<script>
							...
							KindEditor.ready(function(K) {
								...
								editor5.html(HTMLDecode("<s:property value='#request.routeVO.getRouteAdvisory()'/>"));
							});
						</script>
		        	</div>
		        </div>         
		        	...
		        	<div style="display: block; height: 238px;" class="ke-edit">
		        		...
		        		<script>
							...
							KindEditor.ready(function(K) {
								...
								editor6.html(HTMLDecode("<s:property value='#request.routeVO.getRouteStrategy()'/>"));
							});
						</script>
		        	</div>
		        </div>         
		    ...
		    <tr>
		      ...
		      <td align="left" height="30" class="fields_input">
                   ...
                   <s:if test="#request.routeVO.isRouteRecommend() == true">
                   		<input id="route_recommend" type="checkbox" name="route_recommend" checked="checked">
                   </s:if>
                   <s:else>
                   		<input id="route_recommend" type="checkbox" name="route_recommend">
                   </s:else>
                   <label for="route_recommend">推荐</label>
		      </td>
		    </tr>
		    <tr>
		      <td></td>
