		    ...
		    <tr>
		    	<td class="fields_text">名称：</td>
		      	<td class="fields_input">
		          	<input name="news_id" type="hidden" id="news_id" value="<s:property value="#request.tourismNewsVO.getNewsId()"/>">
		          	<input name="news_name" type="text" id="news_name" class="input_long" value="<s:property value="#request.tourismNewsVO.getNewsName()"/>">
		        	...
		        	<div style="display: block; height: 238px;" class="ke-edit">
		        		...
		        		<script>
							...
							KindEditor.ready(function(K) {
								...
								editor1.html(HTMLDecode('<s:property value="#request.tourismNewsVO.getNewsContent()"/>'));
							});
						</script>
		        	</div>
			    </div>
		    ...
		    <tr>
		      	<td class="fields_text">
		       	...
		       	<td align="left" height="30" class="fields_input">
					点击：<input name="news_counts" type="text" id="news_counts" value="<s:property value="#request.tourismNewsVO.getNewsCounts()"/>" class="input_mini" style="width:51px;">
		      	</td>
		    </tr>
		    <tr>
		      <td></td>
