...
<script type="text/javascript">
	$().ready(function(){
		$("#Button1").click(function(){
			...
			$.ajax({
				type:"post",
				url:"/zhonglv/TourismStrategyManagerAction!ajaxAddTourismStrategy.action",
				async:false,
				dataType:"json",
				data:{
		    ...
		    <tr>
		    	<td class="fields_text">名称：</td>
		      	<td class="fields_input">
		          	<input name="strategy_name" type="text" id="strategy_name" class="input_long">
		    ...
		    <tr>
		      	<td class="fields_text">
		       	...
		       	<td align="left" height="30" class="fields_input">
					点击：<input name="strategy_counts" type="text" id="strategy_counts" class="input_mini" style="width:51px;">
		      	</td>
		    </tr>
		    <tr>
		      <td></td>
